...
\begin{mini*}
	  ...
	  \addConstraint{x_0}{=x}{}
        \addConstraint{x_{i+1}}{=Ax_i+Bu_i \quad}{i=0,\hdots,N-1}
        \addConstraint{M_ix_i+E_iu_i}{\leq b_i \quad}{i=0,\hdots,N-1}
        \addConstraint{M_Nx_N}{\leq b_N \quad}{i=0,\hdots,N-1}
    \end{mini*}
...
\begin{mini*}
	  {\theta}{\frac{1}{2}\theta^T Q \theta + c^T \theta}{}{}
	  \addConstraint{A \theta}{=b}{}
        \addConstraint{G \theta}{\leq h}{}
    \end{mini*}
...
\begin{mini*}
	  ...
	  \addConstraint{\mathcal{A} \theta}{=b}{}
        \addConstraint{\mathcal{G} \theta}{\leq h}{}
    \end{mini*}
...
\begin{mini*}
    ...
    \addConstraint{x_0}{=x,}{i=0,\hdots,N-1}
    \addConstraint{x_{i+1}}{=Ax_i + Bu_i, \;}{i=0,\hdots,N-1}
    \addConstraint{Mx_i + Eu_i}{\leq b}{i=0,\hdots,N-1}
    \addConstraint{M_N x_N}{< b_N}{}
\end{mini*}
Remember that:
\begin{itemize}
