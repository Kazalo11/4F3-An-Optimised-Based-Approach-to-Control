...
\]
The optimal input $u_k$ at each step minimises Equation \

{dp1} for the current value of state $x_k$. We can also define 
\[
...
\dot Y = AY + YA^T + BB^T
\]
and $Y(t_1) = \epsilon I$ (this is the Lyapunov equation - easier to solve + integrate4)
